...
create_library_set -name sky130_tc\
   -timing\
    [list ${::IMEX::libVar}/mmmc/RM_IHPSG13_1P_256x48_c2_bm_bist_typ_1p20V_25C.lib\
...
create_library_set -name sky130_bc\
   -timing\
    [list ${::IMEX::libVar}/mmmc/RM_IHPSG13_1P_2048x64_c2_bm_bist_fast_1p32V_m55C.lib\
...
create_library_set -name sky130_wc\
   -timing\
    [list ${::IMEX::libVar}/mmmc/RM_IHPSG13_1P_1024x64_c2_bm_bist_slow_1p08V_125C.lib\
    ...
    ${::IMEX::libVar}/mmmc/sg13g2_stdcell_slow_1p08V_125C.lib\
...
create_constraint_mode -name func_mode_ideal_bc\
   -sdc_files\
    [list ${::IMEX::libVar}/mmmc/func_mode_ideal_bc.sdc]
...
create_constraint_mode -name func_mode_ideal_wc\
   -sdc_files\
    [list ${::IMEX::libVar}/mmmc/func_mode_ideal_wc.sdc]
create_analysis_view -name func_view_tc -constraint_mode func_mode_ideal_wc -delay_corner delay_tc
create_analysis_view -name func_view_bc -constraint_mode func_mode_ideal_bc -delay_corner delay_bc -latency_file ${::IMEX::libVar}/mmmc/latency.sdc
create_analysis_view -name func_view_wc -constraint_mode func_mode_ideal_wc -delay_corner delay_wc -latency_file ${::IMEX::libVar}/mmmc/latency.sdc
